...
#SI EL PRECIO DE VENTA NO SUPERA LOS 50 SOLES EL VENDEDOR PERDERA
if (vendedor_sastifecho<50):
    print("el vendedor a perdido")

#SI EL PRECIO DE VENTA ES IGUAL A 50 SOLES NO GANA Y NI PIERDE
if (vendedor_sastifecho==50):
    print("no gana y ni pierde")
